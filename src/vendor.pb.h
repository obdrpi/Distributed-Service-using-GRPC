...
#ifndef PROTOBUF_INCLUDED_vendor_2eproto
#define PROTOBUF_INCLUDED_vendor_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_vendor_2eproto 
...
class BidQuery : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vendor.BidQuery) */ {
 public:
  ...
  inline BidQuery* New() const final {
    return CreateMaybeMessage<BidQuery>(NULL);
  }

  BidQuery* New(::google::protobuf::Arena* arena) const final {
...
class BidReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vendor.BidReply) */ {
 public:
  ...
  inline BidReply* New() const final {
    return CreateMaybeMessage<BidReply>(NULL);
  }

  BidReply* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_vendor_2eproto
