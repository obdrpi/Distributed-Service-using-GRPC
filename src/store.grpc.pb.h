   ...
   public:
    WithStreamedUnaryMethod_getProducts() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::store::ProductQuery, ::store::ProductReply>(std::bind(&WithStreamedUnaryMethod_getProducts<BaseClass>::StreamedgetProducts, this, std::placeholders::_1, std::placeholders::_2)));
    }
